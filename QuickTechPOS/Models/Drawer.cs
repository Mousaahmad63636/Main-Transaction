...
namespace QuickTechPOS.Models
{
    ...
    public class Drawer
    {
        ...
        /// <summary>
        /// Gets the formatted cash in amount with currency symbol
        /// </summary>
        [NotMapped]
        public string FormattedCashIn => $"${CashIn:F2}";

        /// <summary>
        /// Gets the formatted cash out amount with currency symbol
        /// </summary>
        [NotMapped]
        public string FormattedCashOut => $"${CashOut:F2}";
